 ...
 *
 */
public class FlutterRadioPlugin implements MethodCallHandler, RmxConstants, OnStatusReportListener {
  ...
  private FlutterRadioPlugin(MethodChannel channel) {
  ...
  public static void registerWith(Registrar registrar) {
    ...
    // Plugin instance
    FlutterRadioPlugin plugin = new FlutterRadioPlugin(channel);
  ...
  public void onStatus(RmxAudioStatusMessage what, String trackId, Object param) {
    ...
    Log.v(TAG, "开始向flutter传值");
//    channel.invokeMethod(RmxConstants.STATUS, status);
    channel.invokeMethod("status", param);
  }
}
